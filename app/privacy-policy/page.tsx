      ...
      <div className='min-h-screen  xl:max-w-[1024px] mx-auto pt-[130px] max-xl:px-6  max-w-[768px] pb-2 '>
        <article className={styles.prose}>
          ...
          <p className='pt-6'>
            ...
            you use our browser extension. Please read this Privacy Policy
            carefully. By using Auto Refresh Plus, you agree to the terms of
            this Privacy Policy.
          </p>
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            <li className='mt-4'>
              <strong>Contact Information:</strong> If you contact us for
              support or provide feedback, we may collect your name, email
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            <li className='mt-4'>
              ...
              interactions with the extension, such as the frequency and
              duration of use, using Google Analytics.
            </li>
            <li className='mt-4'>
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            ...
            <li className='mt-4'>
              If the Auto Refresh Plus extension is installed, we also collect
              the extension version, install date, and extension configuration
              for easier debugging and error resolution.
            </li>
            <li className='mt-4'>
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            <li className='mt-4'>
              <strong>To Provide and Maintain the Extension:</strong> Ensuring
              the extension functions correctly and efficiently.
            </li>
            <li className='mt-4'>
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            <li className='mt-4'>
              ...
              extension, conducting our business, or serving our users, so long
          ...
          <p className='!mb-4'>
            ...
            of your personal information when you use the extension. However,
          ...
          <ul className='list-disc pl-[44px] mb-2'>
            ...
            <li className='mt-4'>
              ...
              obligations. Objection: You have the right to object to the
          ...
          <p className='!mb-4'>
            ...
            your use of the extension. Google Analytics collects information
            such as how often users visit the extension, what pages they visit,
            and what other sites they used prior to coming to the extension. We
            use the information we get from Google Analytics to improve our
            extension and services. <br /> <br /> Google Analytics collects only
            the IP address assigned to you on the date you use the extension,
            ...
            Analytics plants a persistent cookie on your web browser to identify
            you as a unique user the next time you use the extension, the cookie
            ...
            the extension is restricted by the Google Analytics Terms of Use and
          ...
          <p className='!mb-4'>
            ...
            posting the new Privacy Policy on our website or through the
            extension. Your continued use of the extension after such changes
            will constitute your acknowledgment of the modified Privacy Policy
            and your agreement to abide by it.
          </p>
          ...
          <p className='!mb-5'>
            ...
            use our extension. Your continued use of the extension following the
